...
class MotionSpec:
    ...
    def to_json(self):
        return json.dumps({"schema_version": 1, "engine_version": "0.2.1", "rig_profile": "player_v1", "curve_encoding": "sparse_ik_bezier" if self.recipe == "natural_wave" else "sparse_axis_angle_bezier", **asdict(self)}, sort_keys=True, ensure_ascii=False, separators=(",", ":"))
